	...
	<table width="100%" cellpadding="3" cellspacing="0" table="table" align="center">
				...
				foreach($inbox as $message) { ?>
                 <tr bgcolor="<?php if($message['isRead'] == '0') { echo'#FFCC66'; } else { echo '#eeeeee'; } ?>">
                        ...
                        <td><a href="/out_msg.php?id=<?php echo htmlspecialchars($message['pmid']);?>&amp;s=" <?php if($message['isRead'] == '0') { echo'class=bold'; } ?>><?php echo decrypt($message['subject']); ?></a></td>
	...
	<table width="4px" cellpadding="4" cellspacing="9" table="table" align="left">
			...
			<?php foreach($favorites_of_you as $myfavorites) { ?><option value="<?php echo htmlspecialchars($myfavorites['vid']);?>"><?php echo htmlspecialchars($myfavorites['title']);?></option> 				<?php } ?></select></td>
                ...
                <tr valign="top">
					...
					<td><input type="text" size="50" class="mailMessageArea" maxlength="75" name="title" value="<?php if(isset($_GET['subject'])) { echo htmlspecialchars($_GET['subject']); } ?>"></td>
                </tr>
                <tr valign="top">
					<td align="right" valign="top"><span class="label">Message:</span></td>
					<td><textarea maxlength="50000" class="mailMessageArea" name="comment" cols="66" rows="6"></textarea></td>
