...
if($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['field_command'] === "update_video") {
  ...
  header("Location: my_videos_upload.php");
	...
	$update_video = $conn->prepare("UPDATE videos SET title = ?, description = ?, tags = ?, address = ?, addrcountry = ?, privacy = ? WHERE vid = ? AND uid = ?");
	...
	<div class="pageTable">
		<table width="100%" cellpadding="5" cellspacing="0" border="0">
			...
			<tbody>
                ...
                <span style="margin-left: 214px" class="formFieldInfo"><b>Enter three or more keywords, separated by spaces, describing your video.</b></span><br>
<span style="margin-left: 214px" class="formFieldInfo">It helps to use relevant keywords so that others can find your video!</span>
	...
	<div class="tableSubtitle">
		...
		<td>
                ...
                <input type="radio" name="private" value="1" <?php if ($video['privacy'] === '1') { echo 'selected'; } ?>> 
                <label for="1"><strong>Public</strong>: Share your video with the world! (Reccomended)</label><br>
                <input type="radio" name="private" value="2" <?php if ($video['privacy'] === '2') { echo 'selected'; } ?>>
