...
?>
<h1>Developer API &#8211; REST Interface</h1>

<p>Calling the YouTube APIs through REST interface is very easy.  All you have to do is make an HTTP request of the REST endpoint:</p>

<div class="codeBox">
	<code>http://www.youtube.com/api2_rest</code>	
</div>

<p>So, requests take this form:</p>

<div class="codeBox">
<code>http://www.youtube.com/api2_rest?api_parameter1=value1&amp;api_parameter2=value2&amp;api_parameterN=valueN</code>
</div>

<p>This is an example REST call:</p>
<div class="codeBox">
<code>http://www.youtube.com/api2_rest?method=youtube.users.get_profile&amp;dev_id=<b>YOUR_DEV_ID</b>&amp;user=<b>YOUTUBE_USER_NAME</b></code>
</div>
