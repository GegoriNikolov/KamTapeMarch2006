...
if ($_GET['method'] == "youtube.videos.list_featured" || $_GET['method'] == "youtube.users.list_favorite_videos" || $_GET['method'] == "youtube.videos.list_by_tag" || $_GET['method'] == "youtube.videos.list_by_user") {
switch($_GET['method']) {
...
<? } elseif ($_GET['method'] == "youtube.videos.get_details") { 
...
<? } elseif ($_GET['method'] == "youtube.users.get_profile") { 
...
<? } elseif ($_GET['method'] == "youtube.users.list_friends") {  
?>
...
<? } elseif ($_GET['method'] == "youtube.videos.get_video_info") { 
if(!isset($_GET['video_id'])) {
echo $missingparam;
die();
}
...
<?
} elseif ($_GET['method'] == "youtube.videos.track_embed_video") {
