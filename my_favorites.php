...
$realcnt->execute([$session['uid']]);
$vidocount = $realcnt->rowCount();
unset($realcnt);
?>
					...
					<tr valign="top">
						<td>
							...
							<table width="130" cellpadding="0" cellspacing="0" border="0">
								<tr align="center">
									<td width="100%">
										<form method="get" action="unfavorite.php" onsubmit="return confirm('Do you want to remove this video from your favorites?');">
						...
						?> 							</div>
							...
							<div class="moduleEntryDetails">Runtime: <?php echo gmdate("i:s", $video['time']); ?> | Views: <?php echo $video['views']; ?> | Comments: <?php echo $video['comments']; ?>
							</td>
						</tr>
					</tbody></table>
					</div><? } } ?>
